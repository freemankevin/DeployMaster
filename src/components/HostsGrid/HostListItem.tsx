    ...
    <div className="group">
      ...
      <div className="flex items-center hover:bg-background-tertiary/50 transition-colors">
        ...
        <div className="w-auto px-4 py-3 flex items-center gap-2 justify-start shrink-0">
          ...
          <button
            onClick={onOpenSFTP}
            className="px-3 py-1.5 bg-background-tertiary text-white border border-border-primary
                     rounded-lg text-xs font-medium
                     transition-all duration-200 ease-macos
                     shadow-macos-button
                     hover:bg-background-elevated hover:border-macos-gray-2
                     active:shadow-macos-button-active active:scale-[0.97]
                     flex items-center gap-1.5 whitespace-nowrap"
          >
          ...
          <div className={`relative ${isMenuOpen ? 'z-50' : ''}`}>
            <button
              ...
              className="flex items-center justify-center w-7 h-7
                       bg-background-tertiary border border-border-primary rounded-lg
      ...
      {/* Expanded Disk Details - Dark Mode */}
                ...
                <div key={index} className="bg-background-secondary rounded-lg p-3 border border-border-primary hover:border-macos-gray-2 transition-colors">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-1.5">
                      ...
                      {isLVM && (
                        <span className="text-[9px] px-1 py-0.5 bg-macos-purple/20 text-macos-purple rounded font-medium">LVM</span>
                      )}
                    </div>
                    <span className="text-[10px] text-text-tertiary font-mono" title={`Device: ${devicePath}`}>
                      {devicePath || '-'}
                    </span>
                  </div>
