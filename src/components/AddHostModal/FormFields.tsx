...
// Basic info fields (name, address, port, username) - Dark Mode
  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      <div className="space-y-2">
        ...
        <input
          type="text"
          className="w-full px-3 py-2.5 bg-background-tertiary border border-border-primary rounded-xl
                   text-[13px] text-white placeholder-text-tertiary
                   transition-all duration-200
                   focus:outline-none focus:border-macos-blue focus:shadow-macos-input-focus
                   hover:border-macos-gray-2"
          placeholder="e.g., Web Server, Database Primary"
          value={formData.name}
      ...
      <div className="space-y-2">
        ...
        <input
          type="text"
          className="w-full px-3 py-2.5 bg-background-tertiary border border-border-primary rounded-xl
                   text-[13px] text-white placeholder-text-tertiary font-mono
                   transition-all duration-200
                   focus:outline-none focus:border-macos-blue focus:shadow-macos-input-focus
                   hover:border-macos-gray-2"
...
// Port and username fields - Dark Mode
        ...
        <button
          ...
          className={`px-4 py-3 rounded-xl border-2 text-[13px] font-medium
                    ...
                    ${formData.auth_type === 'key'
                      ? 'border-macos-blue bg-macos-blue/20 text-macos-blue shadow-glow-blue'
    ...
    <div className="space-y-3">
      <div className="space-y-2">
        ...
        <select
          className="w-full px-3 py-2.5 bg-background-tertiary border border-border-primary rounded-xl
                   ...
                   transition-all duration-200
                   focus:outline-none focus:border-macos-blue focus:shadow-macos-input-focus
                   hover:border-macos-gray-2 appearance-none cursor-pointer"
        ...
        >
          ...
          <option value="__custom__">+ Enter Private Key Manually</option>
        </select>
      </div>
      ...
      {formData.private_key === '__custom__' && (
        <div className="space-y-2 animate-fade-in">
          ...
          <textarea
            className="w-full px-3 py-2.5 bg-background-tertiary border border-border-primary rounded-xl
                     text-[12px] text-white placeholder-text-tertiary font-mono
                     transition-all duration-200
                     focus:outline-none focus:border-macos-blue focus:shadow-macos-input-focus
                     hover:border-macos-gray-2 resize-none"
            rows={6}
    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-3 py-2.5 pr-10 bg-background-tertiary border border-border-primary rounded-xl
                   text-[13px] text-white placeholder-text-tertiary
                   transition-all duration-200
                   focus:outline-none focus:border-macos-blue focus:shadow-macos-input-focus
                   hover:border-macos-gray-2"
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-[12px] text-text-secondary mt-1">
            Authentication settings copied from {copyingHostName}. Please enter new host address and name.
          </p>
        </div>
      </div>
    </div>
